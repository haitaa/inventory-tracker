      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <p className="text-muted-foreground max-w-3xl leading-relaxed mt-2 pl-2">
            Verilerinizi anlamlı raporlara dönüştürün. İşletmenizin durumunu
            analiz edin, eğilimleri belirleyin ve doğru kararlar verin.
          </p>
        </div>
                  ...
                  <div className="relative p-8">
                    <div className="flex flex-col md:flex-row md:items-center gap-8">
                      ...
                      <div className="space-y-4">
                        <h2 className="text-2xl font-bold">Raporlar Nedir?</h2>
                        <p className="text-white/80 max-w-2xl">
                          Raporlar, işletmenizin farklı alanlarındaki verileri
                          anlamlı bilgilere dönüştüren güçlü araçlardır. Satış,
                          envanter, müşteri davranışları, finansal performans
                          gibi kritik alanları izlemenize, analiz etmenize ve
                          stratejik kararlar almanıza olanak tanır.
                        </p>
                ...
                <div className="mt-8">
                  ...
                  >
                    <CardFeature
                      ...
                      description="Satış performansını, ürün bazında satışları, satış trendlerini ve satış ekibinin performansını analiz edin."
                    />
                    <CardFeature
                      icon={<Package className="h-5 w-5" />}
                      title="Envanter Raporları"
                      description="Stok düzeyleri, stok devir hızı, minimum stok seviyeleri ve ürün hareketlerini takip edin."
                    />
                    <CardFeature
                      icon={<Users className="h-5 w-5" />}
                      title="Müşteri Raporları"
                      description="Müşteri kazanımı, sadakati, davranış analizleri ve müşteri segmentasyonu verilerini görüntüleyin."
                    />
                    <CardFeature
                      icon={<Coins className="h-5 w-5" />}
                      title="Finansal Raporlar"
                      description="Gelir-gider analizi, karlılık, nakit akışı ve finansal tahminler oluşturun."
                    />
                    <CardFeature
                      icon={<TrendingUp className="h-5 w-5" />}
                      title="Performans Raporları"
                      description="KPI'lar, hedef takibi ve büyüme analizleri ile işletmenizin performansını ölçün."
                    />
                    <CardFeature
                      icon={<Calendar className="h-5 w-5" />}
                      title="Dönemsel Raporlar"
                      description="Günlük, haftalık, aylık ve yıllık bazda verilerinizi karşılaştırmalı olarak analiz edin."
                    />
                  </motion.div>
                </div>
              </div>
                ...
                <Card className="border-0 bg-white/70 dark:bg-gray-900/50 backdrop-blur-sm shadow-sm overflow-hidden">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription className="text-sm mt-1">
                      Sistemin sunduğu kapsamlı raporlama özellikleri
                    </CardDescription>
                  </CardHeader>
                      ...
                      {[
                        {
                          ...
                          description:
                            "Tarih aralığı, kategori, müşteri, bölge ve daha birçok kritere göre raporlarınızı filtreleyebilirsiniz.",
                        },
                        {
                          icon: (
                          ...
                          description:
                            "Çubuk, çizgi, pasta grafikleri ve gelişmiş görselleştirmelerle verilerinizi kolayca anlayın.",
                        },
                        {
                          icon: <Repeat className="h-4 w-4 text-indigo-500" />,
                          title: "Otomatik Raporlama",
                          description:
                            "Düzenli raporların otomatik olarak oluşturulması ve belirtilen kişilere gönderilmesi.",
                        },
                        {
                          icon: (
                          ...
                          description:
                            "Raporları PDF, Excel, CSV formatlarında dışa aktarma ve paylaşma imkanı.",
                        },
                        {
                          icon: <Layers className="h-4 w-4 text-indigo-500" />,
                          title: "Özel Raporlar",
                          description:
                            "İhtiyaçlarınıza göre özelleştirilmiş raporlar oluşturma ve kaydetme özelliği.",
                        },
                        {
                          icon: (
                          ...
                          description:
                            "Önceden hazırlanmış rapor şablonları ve kişiselleştirilebilir rapor düzenleri.",
                        },
                      ].map((feature, index) => (
                        <div
                          key={index}
              ...
              <div className="space-y-6">
                <div className="bg-white/70 dark:bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 shadow-sm border-0">
                  <h3 className="text-xl font-medium mb-4 flex items-center text-gray-800 dark:text-gray-200">
                    ...
                    Etkili Raporlama İpuçları
                  </h3>

                  <div className="space-y-4 mt-6">
                    {[
                      {
                        title: "Net Hedefler Belirleyin",
                        description:
                          "Her rapor için belirli bir hedef ve soru belirleyin. Ne öğrenmek istediğinizi netleştirin ve raporu buna göre oluşturun.",
                      },
                      {
                        title: "Doğru Metriklere Odaklanın",
                        description:
                          "İşletmeniz için gerçekten önemli olan temel performans göstergelerini (KPI) belirleyin ve raporlarınızı bunlara odaklayın.",
                      },
                      {
                        title: "Görselleştirmeyi Etkili Kullanın",
                        description:
                          "Verileri en iyi temsil eden grafik türlerini seçin. Karmaşık veriler için basit ve anlaşılır görseller kullanın.",
                      },
                      {
                        title: "Düzenli Raporlama Rutini Oluşturun",
                        description:
                          "Günlük, haftalık, aylık ve çeyreklik düzenli raporlama rutini oluşturarak veri analizi alışkanlığı geliştirin.",
                      },
                      {
                        title: "Karşılaştırmalı Analizler Yapın",
                        description:
                          "Mevcut verileri geçmiş dönemlerle, hedeflerle ve sektör ortalamalarıyla karşılaştırarak daha anlamlı içgörüler elde edin.",
                      },
                    ].map((tip, index) => (
                      <div
                        key={index}
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-indigo-600/80 dark:text-indigo-400/80 text-sm">
                          Hikaye anlatımı tekniğini kullanın. Sadece sayıları
                          sunmak yerine, verileri bir hikaye etrafında sunmanız
                          bilgilerin daha kolay anlaşılmasını ve akılda
                          kalmasını sağlar. Her raporda "Neden önemli?", "Ne
                          anlama geliyor?" ve "Bir sonraki adım ne olmalı?"
